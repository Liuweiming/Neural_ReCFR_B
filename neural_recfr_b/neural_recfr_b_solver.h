...
struct ReplayNode {
  ...
  int action_index;
  std::vector<double> next_information;
  std::vector<open_spiel::Action> next_legal_actions;
...
class NeuralReCFRBSolver {
 public:
  ...
  NeuralReCFRBSolver(const Game& game,
                     ...
                     bool anticipatory, double alpha, double eta,
                     double epsilon, bool symmetry, std::mt19937* rng,
